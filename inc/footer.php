    ...
    <footer>
        <section id="relation">
            <figure id="confiance">
                ...
                <div>
                    <img class="logo-relation" src="img/formaposte.jpg">
                    <img class="logo-relation" src="img/missionsemploi.jpg">
                </div>
            </figure>
            <figure>
                <h3>Nos partenaire</h3>
                <div>
                    <img class="logo-relation" src="img/barchen.png">
                    <img class="logo-relation" src="img/certificationvolontaire.jpg">
                </div>
            </figure>
        </section>
        <section>
            ...
            <figure id="certificat">
                ...
                <div>
                    <img class="logo" src="img/datadock.png">
                    <figcaption>
